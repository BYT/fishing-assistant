var CACHE='fa-v13';
var ASSETS=['./','./index.html','./manifest.json','./icon-192.png','./icon-512.png','./bait-anim.gif','./fish-anim.gif','./tiao-m1.gif','./tiao-m2.gif','./tiao-m3.gif','./tiao-m4.gif','./tiao-m5.gif','./tiao-m6.gif'];
